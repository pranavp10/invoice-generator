  ...
  return (
    <div className="bg-[#f7f7f7] flex justify-center items-center">
      <div className="border-l border-r max-w-4xl w-full mx-auto border-dashed h-full flex justify-center flex-col border-gray-300">
        ...
        <p className="font-medium text-xl md:text-3xl border-t border-gray-300 border-b border-dashed md:py-6 text-left py-3 px-7 text-neutral-700">
          Here&apos;s why you&apos;ll love our Free Invoice Generator
        </p>
        <div className="grid sm:grid-cols-2 relative">
          <Plus className="text-orange-500 group-hover:text-orange-500 w-7 h-7 absolute top-0 -translate-x-1/2 -translate-y-1/2 left-0" />
          <Plus className="text-orange-500 group-hover:text-orange-500 w-7 h-7 absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2" />
          <div className="border-r border-b border-dashed p-7 border-gray-300">
            <p className="border flex justify-center items-center w-11 h-11 border-dashed rounded-lg text-2xl mb-5 border-gray-300">
              ⚡️
            </p>
          ...
          <div className="border-b border-dashed p-7 border-gray-300">
            <p className="border flex justify-center items-center w-11 h-11 border-dashed rounded-lg text-2xl mb-5 border-gray-300">
              ♾️
            </p>
          ...
          <div className="border-b border-gray-300 border-dashed p-7">
            <p className="border flex justify-center items-center w-11 h-11 border-dashed rounded-lg text-2xl mb-5 border-gray-300">
              💰
            </p>
          ...
          <div className="border-r border-gray-300 border-b border-dashed p-7">
            <p className="border flex justify-center items-center w-11 h-11 border-dashed rounded-lg text-2xl mb-5 border-gray-300">
              ⏳
            </p>
        ...
        <div className="h-52 flex justify-center rounded-2xl max-w-3xl mx-auto my-20 border-dashed items-center p-4 w-full text-3xl flex-col gap-4  bg-gradient-to-br from-orange-100 to-pink-100">
